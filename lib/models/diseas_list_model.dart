class DistModel {
  ...
  DistModel({this.data, this.links, this.meta});

  DistModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <DListData>[];
      json['data'].forEach((v) {
        data!.add(new DListData.fromJson(v));
      });
    }
...
class DListData {
  ...
  DListData.fromJson(Map<String, dynamic> json) {
    ...
    advertisements = json['advertisements'].cast<int>();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['disease_category_id'] = this.diseaseCategoryId;
